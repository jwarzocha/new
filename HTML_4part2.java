...
public class HTML_4part2 {
	...
	public static void main(String args[]) throws IOException{
		...
		String nazwa_firmy[]= new String[11500];
		String wojewodztwo[]= new String[11500];
		String miejscowosc[]= new String[11500]; 
		String ulica[]= new String[11500];
		String kod_pocztowy[]= new String[11500];
		String osoba_kontaktowa[]= new String[11500];
		String telefon[]= new String[11500];
		String tel_kom[]= new String[11500];
		String adres_www[]= new String[11500];
		String zatrudnienie[]= new String[11500];
		String nip[]= new String[11500];
		String regon[]= new String[11500];
		int j=0;
		int a1=0,a2=0;
		String str="";
